...
void loop()
{
 ...
 // Serial.println(F(""));
  ...
  Serial.print((accel_t_gyro.value.x_accel/16384.0), 2);
  Serial.print(F(", "));
  Serial.print((accel_t_gyro.value.y_accel/16384.0), 2);
  Serial.print(F(", "));
  Serial.print((accel_t_gyro.value.z_accel/16384.0), 2);
  Serial.println(F(""));

  // Print the raw gyro values.

  Serial.print(F("gyro x,y,z : "));
  Serial.print(accel_t_gyro.value.x_gyro/131, DEC);
  Serial.print(F(", "));
  Serial.print(accel_t_gyro.value.y_gyro/131, DEC);
  Serial.print(F(", "));
  Serial.print(accel_t_gyro.value.z_gyro/131, DEC);
  Serial.print(F(", "));
  Serial.println(F(""));

  //val0 = analogRead(analogPin0);     // read the input pin0 
 // voltage=(val0*5.0/1023.0*2);
  //val1 = analogRead(analogPin1);     // read the input pin1
  //Serial.print(F("voltage : "));
 // Serial.println(voltage);   
  //Serial.print(F("current: "));
 // Serial.println(val1*5.0/1023.0); 
  sensor1 =0;
  }
  else{
  //  Serial.print(F("accel x,y,z: "));
